...
2. [Use Cases](./1_UseCaseExamples.md)
3. [Merkle Proofs](./2_MerkleProofs.md)
4. [Let's make an Airdrop](./3_Airdrop.md)
5. [On-Chain Verification](./4_OnChainVerification.md)
6. [Attack Vectors](./5_AttackVectors.md)
